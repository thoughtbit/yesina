...
import com.lkmotion.yesincar.dto.map.Location;
...
public class RouteServiceImpl implements RouteService {
    ...
    @Override
    public Points getPointsAllPage(String carId, String city ,Long startTime, Long endTime) {
		Integer pagesize = 900;
		Points response = new Points();

		Points privateResponse = getPoints(carId, city, startTime, endTime, 1, pagesize);
		...
		for(int i=2;i<=pageMax;i++) {
			privateResponse = getPoints(carId, city, startTime, endTime, i, pagesize);
    ...
    private Points getPoints(String carId, String city ,Long startTime, Long endTime,Integer page,Integer pagesize) {
		Points response = new Points();
		StringBuilder urlBuild = new StringBuilder();

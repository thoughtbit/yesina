...
public enum AccountStatusCode  implements CodeEnum {
    ...
    PHONE_NUM_DIDIT(2003,"手机号不为11位"),
    PHONE_NUM_ERROR(2004,"手机号不正确"),
    TOKEN_NOT_EMPTY(2005,"Token不能为空!"),
    ...
    LARGE_SCREEN_DEVICE_BRAND(2009,"大屏品牌为空"),
    LARGE_SCREEN_DEVICE_CODE(2010,"大屏编号为空"),
    USE_STATUS(2011,"车辆状态为空"),

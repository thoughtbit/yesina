...
public class UnitConverter {
     ...
     * @return 每米价格
     */
    public static BigDecimal kiloToMeterPrice(double price) {
        return BigDecimal.valueOf(price).divide(new BigDecimal("1000"), 5, RoundingMode.DOWN);
    }
     ...
     * @return 每秒价格
     */
    public static BigDecimal minuteToSecondPrice(double price) {
        return BigDecimal.valueOf(price).divide(new BigDecimal("60"), 5, RoundingMode.DOWN);
    }
